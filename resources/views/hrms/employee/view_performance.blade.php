                        ...
                        <div class="col-sm-6">
                            ...
                            <span class="input-group-addon">
                                    ...
                                    <div class="form-group label-floating">
                                        ...
                                        <br><br>
                                        <select class="form-control" name="potential" id="potential" required>
                                            <option></option>
                            ...
                            <span class="input-group-addon">
                                    ...
                                    <div class="form-group label-floating">
                                        ...
                                        <br><br>
                                        <select class="form-control" name="work_quality" id="work_quality" required>
                                            <option></option>
                                            <option>EXCELLENT</option>
                                            <option>GOOD</option>
                                            <option>SATISFACTORY</option>
                            ...
                            <span class="input-group-addon">
                                    ...
                                    <div class="form-group label-floating">
                                        ...
                                        <br><br>
                                        <select class="form-control" name="work_consistency" id="work_consistency"
                                                required>
                                            <option></option>
                                            <option>EXCELLENT</option>
                                            <option>GOOD</option>
                            ...
                            <span class="input-group-addon">
                                    ...
                                    <div class="form-group label-floating">
                                        ...
                                        <br><br>
                                        <select class="form-control" name="communications" id="communications" required>
                                            <option></option>
                                            <option>EXCELLENT</option>
                                            <option>GOOD</option>
                                            <option>SATISFACTORY</option>
                            ...
                            <span class="input-group-addon">
                                    ...
                                    <div class="form-group label-floating">
                                        ...
                                        <br><br>
                                        <select class="form-control" name="independent_work" id="independent_work"
                                                required>
                                            <option></option>
                                            <option>EXCELLENT</option>
                                            <option>GOOD</option>
                            ...
                            <span class="input-group-addon">
                                    ...
                                    <div class="form-group label-floating">
                                        ...
                                        <br><br>
                                        <select class="form-control" name="initiative" id="initiative" required>
                                            <option></option>
                                            <option>EXCELLENT</option>
                                            <option>GOOD</option>
                                            <option>SATISFACTORY</option>
                            ...
                            <span class="input-group-addon">
                                    ...
                                    <div class="form-group label-floating">
                                        ...
                                        <br><br>
                                        <select class="form-control" name="group_work" id="group_work" required>
                                            <option></option>
                                            <option>EXCELLENT</option>
                                            <option>GOOD</option>
                                            <option>SATISFACTORY</option>
                            ...
                            <span class="input-group-addon">
                                    ...
                                    <div class="form-group label-floating">
                                        ...
                                        <br><br>
                                        <select class="form-control" name="productivity" id="productivity" required>
                                            <option></option>
                                            <option>EXCELLENT</option>
                                            <option>GOOD</option>
                                            <option>SATISFACTORY</option>
                            ...
                            <span class="input-group-addon">
                                    ...
                                    <div class="form-group label-floating">
                                        ...
                                        <br><br>
                                        <select class="form-control" name="creativity" id="creativity" required>
                                            <option></option>
                                            <option>EXCELLENT</option>
                                            <option>GOOD</option>
                                            <option>SATISFACTORY</option>
                        ...
                        <div class="col-sm-6">
                            ...
                            <span class="input-group-addon">
                                    ...
                                    <div class="form-group label-floating">
                                        ...
                                        <br><br>
                                        <select class="form-control" name="honesty" id="honesty" required>
                                            <option></option>
                                            <option>EXCELLENT</option>
                                            <option>GOOD</option>
                                            <option>SATISFACTORY</option>
                            ...
                            <span class="input-group-addon">
                                    ...
                                    <div class="form-group label-floating">
                                        ...
                                        <br><br>
                                        <select class="form-control" name="integrity" id="integrity" required>
                                            <option></option>
                                            <option>EXCELLENT</option>
                                            <option>GOOD</option>
                                            <option>SATISFACTORY</option>
                            ...
                            <span class="input-group-addon">
                                    ...
                                    <div class="form-group label-floating">
                                        ...
                                        <br><br>
                                        <select class="form-control" name="coworker_relations" id="coworker_relations"
                                                required>
                                            <option></option>
                                            <option>EXCELLENT</option>
                                            <option>GOOD</option>
                            ...
                            <span class="input-group-addon">
                                    ...
                                    <div class="form-group label-floating">
                                        ...
                                        <br><br>
                                        <select class="form-control" name="client_relations" id="client_relations"
                                                required>
                                            <option></option>
                                            <option>EXCELLENT</option>
                                            <option>GOOD</option>
                            ...
                            <span class="input-group-addon">
                                    ...
                                    <div class="form-group label-floating">
                                        ...
                                        <br><br>
                                        <select class="form-control" name="dependability" id="dependability" required>
                                            <option></option>
                                            <option>EXCELLENT</option>
                                            <option>GOOD</option>
                                            <option>SATISFACTORY</option>
